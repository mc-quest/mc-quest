...
public class ItemLoader {
    ...
    private void loadItems(String resourcesPath, Class<? extends Item> itemType, ItemManager itemManager) {
        List<String> itemPaths = ResourceLoader.getResources(resourcesPath);
        for (String itemPath : itemPaths) {
            Item item = ResourceLoader.deserializeJsonResource(itemPath, itemType);
